...
archive_index_data = [
    {"locale": "en-CA",
     "path": os.path.join(aidb_dir, "ArchiveIndex_Beta_Install.mdb")},
    {"locale": "fr-CA",
     "path": os.path.join(aidb_dir, "ArchiveIndex_Beta_Install_fr.mdb")},
    {"locale": "es-MX",
     "path": os.path.join(aidb_dir, "ArchiveIndex_Beta_Install_es.mdb")},
    {"locale": "ru-RU",
     "path": os.path.join(aidb_dir, "ArchiveIndex_Beta_Install_ru.mdb")},
    {"locale": "pl-PL",
     "path": os.path.join(aidb_dir, "ArchiveIndex_Beta_Install.mdb")} #since there is no polish aidb, use the english terms
]
