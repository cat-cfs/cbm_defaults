select spatial_unit.id, admin_boundary_tr.name, eco_boundary_tr.name from spatial_unit
...
where admin_boundary_tr.locale_id = eco_boundary_tr.locale_id and locale.code = "en-CA"
